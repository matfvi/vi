...
# -------------------------------------------------------------------------------------------------------------------
"""
Primer upotrebe klasifikatora zasnovanog na višestrukim stablima odlučivanja.
http://scikit-learn.org/stable/modules/generated/sklearn.ensemble.RandomForestClassifier.html

Osnovna ideja je da se umesto jednog stabla odlucivanja, trenira vise stabala
odlucivanja koji se kasnije koriste da 'glasaju' pri predikciji.
"""
...
def main():
    ...
    # Pravimo klasifikator (videti dokumentaciju)
    # - n_estimators -> Broj stabala koji ce biti obucavani (default: 10)
