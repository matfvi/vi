...
def main():
    ...
    train_conf = sklearn.metrics.confusion_matrix(y_train, y_train_predict)
    test_conf = sklearn.metrics.confusion_matrix(y_test, y_test_predict)
    print("Trening matrica konfuzije\n{}".format(train_conf))
    print("Test matrica konfuzije\n{}".format(test_conf))
